...
public class ExtensionActionsBridge implements Destroyable {
    ...
    public String[] getPinnedActionIds(boolean incognito) {
        return ExtensionActionsBridgeJni.get().getPinnedActionIds(mNativeExtensionActionsBridge, incognito);
    }
    ...
    public interface Natives {
        ...
        @JniType("std::vector<std::string>")
        String[] getPinnedActionIds(long nativeExtensionActionsBridge, boolean incognito);
